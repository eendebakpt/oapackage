		...
		*/
		...
		std::vector<cperm> doubleConferenceInflate(const std::vector<cperm> &ccX, const array_link &als, const DconferenceFilter &filter, const conference_t &ct, int verbose)
		{
		...
		std::vector<cperm> generateDoubleConferenceExtensionsInflate ( const array_link &al, const conference_t &ct, int verbose, int filterj2, int filterj3, int kstart=-1 )
		{
