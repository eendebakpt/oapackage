...
The array_link struct is a struct that represents an arrays. Copying of array
links is done with shallow copy or deep copy depending on compile time options!  
...
%feature("docstring") arraysymmetry::N "
";
...
%feature("docstring") conf_candidates_t::info "
";
...
%feature("docstring") LMC_static_struct_t::init_rootrowperms "
...
matrix of many arrays sharing a common subarray  
...
aberration for asymmetrical fractional factorial desings\" The non-symmetric
arrays see \"Algorithmic Construction of Efficient Fractional Factorial Designs
...
%feature("docstring") Eigen::printfstring "
...
%feature("docstring") Eigen::getJcounts "
...
%feature("docstring") partial_inner_product "
...
%feature("docstring") filterZeroPosition "
...
Arguments: arrayclass: structure describing the design class alpha: (3x1 array)
...
helper function, create array with root and elements of additional columns set
to 1000  
";
...
Return all column combinations including a fixed column. At the same time
allocate space for the number of values these columns have  
